    ...
    <style>
        ...
        * {
        ...
        .header-tabs a {
            ...
            /* cho phép xuống dòng như "Sản phẩm" */
        }
...
<body>
    ...
    <div class="container-fluid tab-bar">
        <div class="header-tabs mt-2">
            <a href="{{ route('nhanvien.sanpham') }}" class="">Sản phẩm</a>
            <a href="{{ route('customers.index') }}" class="">Khách hàng</a>
            <a href="{{ route('donhang.index') }}" class="">Đơn hàng</a>
            <a href="{{ route('nhanvien.doanhthu') }}">Báo cáo doanh thu</a>
        </div>
    </div>
